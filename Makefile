...
.PHONY: build-all build-comment build-post build-prometheus build-blackbox-exporter build-grafana push-grafana push-ui push-comment push-post push-prometheus push-blackbox-exporter push-all start stop
